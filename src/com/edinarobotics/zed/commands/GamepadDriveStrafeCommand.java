...
public class GamepadDriveStrafeCommand extends Command{
     ...
     */
    public GamepadDriveStrafeCommand(Gamepad gamepad, FilterSet filters, DrivetrainStrafe drivetrainStrafe){
        super(COMMAND_NAME);
        this.gamepad = gamepad;
        this.filters = filters;
        this.drivetrainStrafe = drivetrainStrafe;
     ...
     * @param drivetrain The drivetrain object to control.
     */
    public GamepadDriveStrafeCommand(Gamepad gamepad, DrivetrainStrafe drivetrainStrafe){
        super(COMMAND_NAME);
